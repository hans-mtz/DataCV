...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _https://github.com/hans-mtz/DataCV_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/hans-mtz/DataCV/raw/master/hans_cv.pdf)")
}
```
...
```{r}
CV %>% print_skill_bars(skills="langs")
```
